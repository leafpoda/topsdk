<?php
/**
 * TOP API: taobao.universalbp.new.report.async.download.find.task.page request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewReportAsyncDownloadFindTaskPageRequest
{
	/** 
	 * asyncRptQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.report.async.download.find.task.page";
	}
