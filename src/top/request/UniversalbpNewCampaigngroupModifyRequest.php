<?php
/**
 * TOP API: taobao.universalbp.new.campaigngroup.modify request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCampaigngroupModifyRequest
{
	/** 
	...
	{
		return "taobao.universalbp.new.campaigngroup.modify";
	}
