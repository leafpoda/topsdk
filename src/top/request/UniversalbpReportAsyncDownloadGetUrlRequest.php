<?php
/**
 * TOP API: taobao.universalbp.report.async.download.get.url request
 * 
 * @author auto create
 * @since 1.0, 2023.07.19
 */
class UniversalbpReportAsyncDownloadGetUrlRequest
{
	/** 
	 * 报表异步下载任务查询对象
	 **/
	...
	{
		return "taobao.universalbp.report.async.download.get.url";
	}
