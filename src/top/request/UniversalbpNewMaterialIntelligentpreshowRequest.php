<?php
/**
 * TOP API: taobao.universalbp.new.material.intelligentpreshow request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewMaterialIntelligentpreshowRequest
{
	/** 
	 * itemQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.material.intelligentpreshow";
	}
