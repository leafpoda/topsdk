<?php
/**
 * TOP API: taobao.universalbp.new.crowd.horizontal.modifybidprice request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCrowdHorizontalModifybidpriceRequest
{
	/** 
	...
	{
		return "taobao.universalbp.new.crowd.horizontal.modifybidprice";
	}
