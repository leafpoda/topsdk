<?php
/**
 * TOP API: taobao.zuanshi.advertiser.account.rpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.03.01
 */
class ZuanshiAdvertiserAccountRptsTotalGetRequest
{
	/** 
	...
	{
		return "taobao.zuanshi.advertiser.account.rpts.total.get";
	}
