<?php
/**
 * TOP API: taobao.universalbp.new.adzone.horizontal.findpage request
 * 
 * @author auto create
 * @since 1.0, 2024.04.08
 */
class UniversalbpNewAdzoneHorizontalFindpageRequest
{
	/** 
	 * adzoneRefQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.adzone.horizontal.findpage";
	}
