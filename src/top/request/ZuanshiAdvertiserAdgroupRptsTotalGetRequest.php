<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adgroup.rpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.04.18
 */
class ZuanshiAdvertiserAdgroupRptsTotalGetRequest
{
	/** 
	 * 推广单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adgroup.rpts.total.get";
	}
