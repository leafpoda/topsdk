<?php
/**
 * TOP API: taobao.universalbp.new.campaign.onebpdisplay.batchupdate request
 * 
 * @author auto create
 * @since 1.0, 2024.12.26
 */
class UniversalbpNewCampaignOnebpdisplayBatchupdateRequest
{
	/** 
	 * campaignBidListVO
	 **/
	...
	{
		return "taobao.universalbp.new.campaign.onebpdisplay.batchupdate";
	}
