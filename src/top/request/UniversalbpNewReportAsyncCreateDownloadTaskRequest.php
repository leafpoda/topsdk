<?php
/**
 * TOP API: taobao.universalbp.new.report.async.create.download.task request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewReportAsyncCreateDownloadTaskRequest
{
	/** 
	 * reportQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.report.async.create.download.task";
	}
