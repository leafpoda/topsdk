<?php
/**
 * TOP API: taobao.universalbp.new.campaign.bid.batchupdate request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCampaignBidBatchupdateRequest
{
	/** 
	 * campaignBidListVO
	 **/
	...
	{
		return "taobao.universalbp.new.campaign.bid.batchupdate";
	}
