<?php
/**
 * TOP API: taobao.universalbp.material.intelligentpreshow request
 * 
 * @author auto create
 * @since 1.0, 2023.07.19
 */
class UniversalbpMaterialIntelligentpreshowRequest
{
	/** 
	 * itemQueryVO
	 **/
	...
	{
		return "taobao.universalbp.material.intelligentpreshow";
	}
