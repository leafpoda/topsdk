<?php
/**
 * TOP API: taobao.universalbp.new.campaign.onerecover request
 * 
 * @author auto create
 * @since 1.0, 2024.08.27
 */
class UniversalbpNewCampaignOnerecoverRequest
{
	/** 
	 * oneClickVO
	 **/
	...
	{
		return "taobao.universalbp.new.campaign.onerecover";
	}
