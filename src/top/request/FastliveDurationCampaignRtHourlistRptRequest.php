<?php
/**
 * TOP API: taobao.fastlive.duration.campaign.rt.hourlist.rpt request
 * 
 * @author auto create
 * @since 1.0, 2024.04.03
 */
class FastliveDurationCampaignRtHourlistRptRequest
{
	/** 
	 * 查询条件
	 **/
	...
	{
		return "taobao.fastlive.duration.campaign.rt.hourlist.rpt";
	}
