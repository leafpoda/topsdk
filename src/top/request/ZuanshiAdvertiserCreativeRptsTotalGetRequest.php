<?php
/**
 * TOP API: taobao.zuanshi.advertiser.creative.rpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.03.01
 */
class ZuanshiAdvertiserCreativeRptsTotalGetRequest
{
	/** 
	 * 单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.creative.rpts.total.get";
	}
