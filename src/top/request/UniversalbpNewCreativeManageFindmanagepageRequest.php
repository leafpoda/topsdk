<?php
/**
 * TOP API: taobao.universalbp.new.creative.manage.findmanagepage request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCreativeManageFindmanagepageRequest
{
	/** 
	 * creativeQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.creative.manage.findmanagepage";
	}
