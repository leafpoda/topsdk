<?php
/**
 * TOP API: taobao.onebp.display.campaign.group.modify request
 * 
 * @author auto create
 * @since 1.0, 2021.12.02
 */
class OnebpDisplayCampaignGroupModifyRequest
{
	/** 
	 * 计划组
	 **/
	...
	{
		return "taobao.onebp.display.campaign.group.modify";
	}
