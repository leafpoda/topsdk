<?php
/**
 * TOP API: taobao.universalbp.new.algo.geteffectprediction request
 * 
 * @author auto create
 * @since 1.0, 2024.08.27
 */
class UniversalbpNewAlgoGeteffectpredictionRequest
{
	/** 
	 * algoQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.algo.geteffectprediction";
	}
