<?php
/**
 * TOP API: taobao.zuanshi.advertiser.campaign.rpts.day.get request
 * 
 * @author auto create
 * @since 1.0, 2021.11.23
 */
class ZuanshiAdvertiserCampaignRptsDayGetRequest
{
	/** 
	 * 计划id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.campaign.rpts.day.get";
	}
