<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adgroup.rtrpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.04.03
 */
class ZuanshiAdvertiserAdgroupRtrptsTotalGetRequest
{
	/** 
	 * 单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adgroup.rtrpts.total.get";
	}
