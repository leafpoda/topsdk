<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adgroup.rtrpts.get request
 * 
 * @author auto create
 * @since 1.0, 2024.04.18
 */
class ZuanshiAdvertiserAdgroupRtrptsGetRequest
{
	/** 
	 * 推广单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adgroup.rtrpts.get";
	}
