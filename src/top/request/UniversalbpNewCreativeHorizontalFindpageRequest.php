<?php
/**
 * TOP API: taobao.universalbp.new.creative.horizontal.findpage request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCreativeHorizontalFindpageRequest
{
	/** 
	 * creativeQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.creative.horizontal.findpage";
	}
