<?php
/**
 * TOP API: taobao.unidesk.rta.ad.creative.program.add request
 * 
 * @author auto create
 * @since 1.0, 2023.02.01
 */
class UnideskRtaAdCreativeProgramAddRequest
{
	/** 
	 * 入参
	 **/
	...
	{
		return "taobao.unidesk.rta.ad.creative.program.add";
	}
