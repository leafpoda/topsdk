<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adzone.rpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.04.03
 */
class ZuanshiAdvertiserAdzoneRptsTotalGetRequest
{
	/** 
	 * 单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adzone.rpts.total.get";
	}
