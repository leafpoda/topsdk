<?php
/**
 * TOP API: taobao.universalbp.new.campaign.onebpsearch.batchupdate request
 * 
 * @author auto create
 * @since 1.0, 2024.12.26
 */
class UniversalbpNewCampaignOnebpsearchBatchupdateRequest
{
	/** 
	 * campaignBidListVO
	 **/
	...
	{
		return "taobao.universalbp.new.campaign.onebpsearch.batchupdate";
	}
