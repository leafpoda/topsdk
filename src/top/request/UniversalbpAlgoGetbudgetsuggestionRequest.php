<?php
/**
 * TOP API: taobao.universalbp.algo.getbudgetsuggestion request
 * 
 * @author auto create
 * @since 1.0, 2024.06.04
 */
class UniversalbpAlgoGetbudgetsuggestionRequest
{
	/** 
	 * algoQueryVO
	 **/
	...
	{
		return "taobao.universalbp.algo.getbudgetsuggestion";
	}
