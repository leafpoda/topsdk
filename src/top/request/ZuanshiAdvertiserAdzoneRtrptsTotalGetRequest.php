<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adzone.rtrpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.03.01
 */
class ZuanshiAdvertiserAdzoneRtrptsTotalGetRequest
{
	/** 
	 * 推广单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adzone.rtrpts.total.get";
	}
