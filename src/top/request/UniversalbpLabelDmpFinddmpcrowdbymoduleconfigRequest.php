<?php
/**
 * TOP API: taobao.universalbp.label.dmp.finddmpcrowdbymoduleconfig request
 * 
 * @author auto create
 * @since 1.0, 2023.07.18
 */
class UniversalbpLabelDmpFinddmpcrowdbymoduleconfigRequest
{
	/** 
	...
	{
		return "taobao.universalbp.label.dmp.finddmpcrowdbymoduleconfig";
	}
