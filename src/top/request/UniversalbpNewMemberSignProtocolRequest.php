<?php
/**
 * TOP API: taobao.universalbp.new.member.sign.protocol request
 * 
 * @author auto create
 * @since 1.0, 2024.12.12
 */
class UniversalbpNewMemberSignProtocolRequest
{
	/** 
	 * protocolVO
	 **/
	...
	{
		return "taobao.universalbp.new.member.sign.protocol";
	}
