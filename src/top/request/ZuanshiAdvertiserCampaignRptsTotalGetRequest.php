<?php
/**
 * TOP API: taobao.zuanshi.advertiser.campaign.rpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2024.04.18
 */
class ZuanshiAdvertiserCampaignRptsTotalGetRequest
{
	/** 
	 * 计划id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.campaign.rpts.total.get";
	}
