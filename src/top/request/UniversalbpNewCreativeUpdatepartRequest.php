<?php
/**
 * TOP API: taobao.universalbp.new.creative.updatepart request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCreativeUpdatepartRequest
{
	/** 
	...
	{
		return "taobao.universalbp.new.creative.updatepart";
	}
