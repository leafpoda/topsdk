<?php
/**
 * TOP API: taobao.universalbp.new.stdcategory.findcategorycondition request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewStdcategoryFindcategoryconditionRequest
{
	/** 
	 * stdCategoryQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.stdcategory.findcategorycondition";
	}
