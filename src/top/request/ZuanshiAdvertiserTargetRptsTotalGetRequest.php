<?php
/**
 * TOP API: taobao.zuanshi.advertiser.target.rpts.total.get request
 * 
 * @author auto create
 * @since 1.0, 2018.07.25
 */
class ZuanshiAdvertiserTargetRptsTotalGetRequest
{
	/** 
	 * 单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.target.rpts.total.get";
	}
