<?php
/**
 * TOP API: taobao.universalbp.new.adgroup.horizontal.findpage request
 * 
 * @author auto create
 * @since 1.0, 2024.01.30
 */
class UniversalbpNewAdgroupHorizontalFindpageRequest
{
	/** 
	 * adgroupQueryVO
	 **/
	...
	{
		return "taobao.universalbp.new.adgroup.horizontal.findpage";
	}
