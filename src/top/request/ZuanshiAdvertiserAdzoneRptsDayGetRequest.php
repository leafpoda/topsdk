<?php
/**
 * TOP API: taobao.zuanshi.advertiser.adzone.rpts.day.get request
 * 
 * @author auto create
 * @since 1.0, 2021.11.25
 */
class ZuanshiAdvertiserAdzoneRptsDayGetRequest
{
	/** 
	 * 单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.adzone.rpts.day.get";
	}
