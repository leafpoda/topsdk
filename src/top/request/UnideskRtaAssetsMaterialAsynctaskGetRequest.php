<?php
/**
 * TOP API: taobao.unidesk.rta.assets.material.asynctask.get request
 * 
 * @author auto create
 * @since 1.0, 2023.07.21
 */
class UnideskRtaAssetsMaterialAsynctaskGetRequest
{
	/** 
	 * 查询参数
	 **/
	...
	{
		return "taobao.unidesk.rta.assets.material.asynctask.get";
	}
