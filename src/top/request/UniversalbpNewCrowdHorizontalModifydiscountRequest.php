<?php
/**
 * TOP API: taobao.universalbp.new.crowd.horizontal.modifydiscount request
 * 
 * @author auto create
 * @since 1.0, 2024.01.15
 */
class UniversalbpNewCrowdHorizontalModifydiscountRequest
{
	/** 
	...
	{
		return "taobao.universalbp.new.crowd.horizontal.modifydiscount";
	}
