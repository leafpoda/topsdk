<?php
/**
 * TOP API: taobao.zuanshi.advertiser.target.rpts.day.get request
 * 
 * @author auto create
 * @since 1.0, 2024.03.01
 */
class ZuanshiAdvertiserTargetRptsDayGetRequest
{
	/** 
	 * 单元id
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.target.rpts.day.get";
	}
