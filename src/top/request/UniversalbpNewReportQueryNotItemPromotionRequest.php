<?php
/**
 * TOP API: taobao.universalbp.new.report.query.not.item.promotion request
 * 
 * @author auto create
 * @since 1.0, 2024.04.08
 */
class UniversalbpNewReportQueryNotItemPromotionRequest
{
	/** 
	...
	{
		return "taobao.universalbp.new.report.query.not.item.promotion";
	}
