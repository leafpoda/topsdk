 ...
 * @author auto create
 */
class AdgroupBidCommandVo
{
	
	/** 
	 * 单元id,单元已经存在场景必填,eg:修改出价等场景
	 **/
	public $adgroup_id;
	
	/** 
	 * 是否开启新品创意，true:是，false:否
	 **/
	public $enable_cold_speed_new_item;
