<?php
/**
 * TOP API: taobao.zuanshi.advertiser.rpts.download.day.total.get request
 * 
 * @author auto create
 * @since 1.0, 2018.07.25
 */
class ZuanshiAdvertiserRptsDownloadDayTotalGetRequest
{
	/** 
	 * 计划类型。1：全店推广；4单品推广
	 **/
	...
	{
		return "taobao.zuanshi.advertiser.rpts.download.day.total.get";
	}
